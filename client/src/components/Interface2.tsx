  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-row p-2 h-full gap-2">
        ...
        <div className="w-3/4 lg:w-2/3 flex flex-col space-y-2">
          {/* Reference container occupying 4/5 screen height */}
          <div className="h-[80vh] overflow-auto">
            <Reference references={references} />
          </div>
          {/* Conversation container occupying 4/5 screen height, 40px bottom margin */}
          <div id="realTimeConversation" ref={conversationRef} className="relative h-[80vh] overflow-y-auto p-2 bg-white rounded-lg shadow-inner mb-[40px]">
